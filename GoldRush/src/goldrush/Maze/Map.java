...
public class Map {
	...
	// public AePlayWave oxygenCollect = new AePlayWave("Sounds/Oxygen Tank
	// Pickup.wav");
	...
	/*
	 * The map constructor initializes the background and lays the foundation
	 * for the types of rooms in the roomData array.
	 */
	public Map(int aW, int aH, float aWW, float aWH) {
		background = new Background(0f, 0f);
		roomData = new RoomData[] {
				new RoomData(
						"Images/Background-Normal.png")/* Room 0- Beginning */,
				new RoomData("Images/Background-Normal.png",
						"GoldIntroduction")/* Room 1 - Gold Intro */,
				new RoomData("Images/Background-Normal.png",
						"OxygenIntroduction")/* Room 2 - Oxygen Intro */,
				new RoomData("Images/Background-Normal.png",
						"Room3")/* Room 3 - Branching path 1 */,
				new RockChallengeRoom("Images/Background-Challenge.png",
						"FallingRocks")/* Room 4 -Rock room 1 */,
				new LavaRoom("Images/Background-Lava.png",
						"LavaRoom")/* Room 5 */,
				new QTERoom("Images/Background-Challenge.png",
						"QTE")/* Room 6 QTE */,
				new RoomData(
						"Images/Background-Challenge.png")/*
															 * Room 7 Challenge
															 * Gold Room
															 */,
				new LavaRoom("Images/Background-Lava.png",
				...
				new RoomData("Images/Background-Normal.png")/* Roomn13 */, new RockChallengeRoom(
						"Images/Background-Challenge.png")/* Room 14 */
		};
	...
	private void initialize() {
		...
		// roomData[0].addWarpTile(new WarpTile(10, 7f, 0f, leftX, leftY, false,
		// leftDegree, "Normal"));//this is for the exit
		...
		// roomData[4].setStuff(appWidth, appHeight, appWorldWidth,
		// appWorldHeight);
		...
		// roomData[5].setStuff(appWidth, appHeight, appWorldWidth,
		// appWorldHeight);
		...
		// roomData[11].setStuff(appWidth, appHeight, appWorldWidth,
		// appWorldHeight);
		...
		// roomData[14].db.get(0).setBB(appWidth, appHeight, appWorldWidth,
		// appWorldHeight);
