public class Map {
	...
	public void initialize(int appWidth, int appHeight, float appWorldWidth, float appWorldHeight) {
		...
		WarpTile s3 = new WarpTile(2, 7f, 0f, -7.8f, 0, true);
		...
		// Room 2 Tile 0
		WarpTile s4 = new WarpTile(1, -7f, 0, 7.7f, 0f, false);
		WarpTile s5 = new WarpTile(3, 7f, 0f, -7.8f, 0, false);
		
		// Room 3 Tile 0
		WarpTile s6 = new WarpTile(2, -7f, 0, 7.7f, 0f, false);
